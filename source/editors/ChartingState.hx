...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		'Hurt Note',
		'Heptanote',
		'Insta Kill Note', //alot of these are trolls and leaks :troll: HAHH
		'Scythe Note',
		'GF Sing',
		'No Animation'
	];
	...
	[
		...
		['Set Camera Zoom', "Value 1: The zoom you want (example: 1)\n1 is the zoom that the camera will set to.\nLeave Value 2 Blank."],
		['White Flash', "Value 1: Duration of the flash\nValue 2: Blank"]
	];
