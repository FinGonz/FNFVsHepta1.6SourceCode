...
class VisualsUISubState extends BaseOptionsMenu
{
	public function new()
	{
		...
		var option:Option = new Option('Judgement Counter',
			'If checked, shows the judgement counter.\nThis counts how many ratings you have hit.',
			'judgement',
			'bool',
			true);
		addOption(option);
		...
		var option:Option = new Option('Hide Watermark', //kade engine watermark except y e s
			'If checked, hides the watermark on the bottom left corner.',
			'hideWatermark',
			'bool',
			false);
		addOption(option);
		...
		var option:Option = new Option('Lane Underlay',
			"If checked, there will be an underlay\nunderneath the notes.",
			'laneunderlay',
			'bool',
			true);
		addOption(option);
