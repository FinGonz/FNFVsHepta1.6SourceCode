...
class GameplaySettingsSubState extends BaseOptionsMenu
{
	public function new()
	{
		...
		var option:Option = new Option('Moving Camera',
			'If unchecked, the camera moves when you\nor the opponent hits a note.',
			'camMove',
			'bool',
			false);
		addOption(option);
		...
		var option:Option = new Option('Freeplay Cutscenes',
			'If checked, dialogue appears in Freeplay.',
			'freeplayDialogue',
			'bool',
			false);
		addOption(option);
		...
		var option:Option = new Option('Hitsounds',
			'If checked, a sound will play when you hit a note.',
			'hitsounds',
			'bool',
			true); 
		addOption(option);
