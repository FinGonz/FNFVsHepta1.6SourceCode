...
class ClientPrefs {
	...
	public static function saveSettings() {
		...
		FlxG.save.data.spamFound = spamFound;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.spamFound != null) {
			spamFound = FlxG.save.data.spamFound;
		}
